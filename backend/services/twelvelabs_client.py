...
class TwelveLabsClient:
    ...
    def _ensure_index(self) -> str:
        ...
        indexes = self._client.index.list()
        for idx in indexes:
    ...
    def index_video(self, video_path: str) -> str:
    ...
    def _wait_for_task(self, task: Task, timeout: int = 600) -> Task:
        start = time.time()
    ...
    def _parse_response(self, text: str) -> dict:
        ...
        try:
            ...
            return {
                ...
                "campaign_relevance": {"score": 50, "label": "ON-BRIEF", "reasoning": "Parse error, defaulting"},
                "policy_violations": [],
                "decision": "REVIEW",
